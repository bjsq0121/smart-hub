...
const NAV_GROUPS = {
  ...
  ops: {
    ...
    subs: [
      ...
      { id: 'coin-at-perf', label: '🤖 자동매매 성과', page: 'page-ops', opsPane: 'coin-at-perf',
        onActivate: () => { if (typeof loadCoinAutoPerf === 'function') loadCoinAutoPerf(); } },
  ...
  stockOps: {
    ...
    subs: [
      ...
      { id: 'stock-at-perf', label: '🤖 자동매매 성과', page: 'page-stock-ops', stockOpsPane: 'at-perf',
        onActivate: () => { if (typeof loadStockAutoPerf === 'function') loadStockAutoPerf(); } },
    ],
